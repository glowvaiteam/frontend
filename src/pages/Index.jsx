            ...
            {!user && (
              <div className="mb-8 px-4 text-center">
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6">
                  AI-Driven Skin Analysis. Real Skincare Decisions{" "}
                  <span className="text-gradient">GLOWVAI</span>
                </h1>
                <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                  Discover your perfect skincare routine with AI-powered insights.
                </p>
                <div className="flex justify-center gap-4">
                  ...
                  <Button asChild size="lg" className="rounded-full bg-white/20 text-black border border-black px-6 py-2 hover:bg-yellow-200 hover:text-black hover:border-yellow-300">
